...
namespace Debug
{
  ...
  void PushGizmo(const camera* Camera, const mat4* GizmoBase, bool overlay = true);
  void PushWireframeSphere(const camera* Camera, vec3 Position, float Radius, bool Overlay = false,
